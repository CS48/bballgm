              ...
              .map((player) => {
                ...
                return (
                  <div key={player.player_id} className="flex items-center border-b border-gray-200 py-2">
                    {/* Player Name */}
                    <div className="text-sm font-medium w-32 flex-shrink-0">{player.name}</div>
                    {/* Position | OVR */}
                    <div className="text-sm text-muted-foreground w-24 flex-shrink-0">
                      {player.position} | {player.overall_rating} ovr
                    </div>
                    {/* Total Minutes */}
                    <div className="text-sm text-muted-foreground w-16 flex-shrink-0 ml-4">{totalMinutes} min</div>
                    {/* Minute rectangles */}
                    <div
